describe Preferences do
	...
	context "on instantiation it has" do 
		...
		it "google maps prefs" do 
			expect(alberts_prefs.google_maps).to eq(false) 
		end	
		...
		it "a destination for gmaps set to old street" do 
			expect(alberts_prefs.google_search_maps).to eq("Old Street, London") 
		end
